        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active"><a  href="<?php echo base_url() . 'pessoa'; ?>">Cadastrar Pessoa <span class="sr-only">(current)</span></a></li>
                    <li><a href="<?php echo base_url() . 'listar'; ?>">Buscar Pessoas <span class="sr-only">(current)</span></a></li>
                    <li class="dropdown">
